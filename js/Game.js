class Game {
  ...
  start() {
    ...
    var obstacle1Positions = [
      { x: width / 2 - 150, y: height - 2800, image: obstacle1Image },
      { x: width / 2 + 250, y: height - 9000, image: obstacle1Image },
      { x: width / 2 - 180, y: height - 3400, image: obstacle1Image },
     
      { x: width / 2 - 150, y: height - 5300, image: obstacle1Image },
      { x: width / 2, y: height - 5301, image: obstacle1Image },
    ];
